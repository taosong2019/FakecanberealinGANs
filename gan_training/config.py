...
def build_optimizers(generator, discriminator, config):
    ...
    if optimizer == 'rmsprop':
        ...
        # g_optimizer = optim.RMSprop(g_params, lr=lr_g, alpha=0.9, eps=1e-8)
        # d_optimizer = optim.RMSprop(d_params, lr=lr_d, alpha=0.9, eps=1e-8)
    elif optimizer == 'adam':
        ...
        g_optimizer = optim.Adam(g_params, lr=lr_g, betas=(0., 0.9), eps=1e-8)
        d_optimizer = optim.Adam(d_params, lr=lr_d, betas=(0., 0.9), eps=1e-8)
    elif optimizer == 'sgd':
